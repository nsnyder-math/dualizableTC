...
\usetikzlibrary{arrows,backgrounds,patterns,scopes,
...
\newlength{\framebasewidth}
\setlength{\framebasewidth}{.8pt}
\newlength{\framewidth}
\setlength{\framewidth}{1.6pt}
\newcommand{\framelengthshort}{.04}
\newcommand{\framelengthlong}{.1}
\newcommand{\seqstep}{1/6}

\newcommand{\framebasecolor}{black!30}
