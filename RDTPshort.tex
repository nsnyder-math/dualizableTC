...
We will assume some familiarity with the theory of tensor categories and module categories as in the work of Etingof, Gelaki, Nikshych, and Ostrik~\cite{EGNO, EO-ftc, MR2183279, MR2097289,0909.3140}.  For a reader desiring more background we recommend the notes \cite{EGNO} which have recently been expanded into a book \cite{egno-book} (which includes more exposition).  We will begin by recalling some key definitions and results from EGNO.
