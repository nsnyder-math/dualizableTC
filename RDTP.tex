...
The relative Deligne tensor product was first constructed by Etingof-Nikshych-Ostrik under the assumption that $\cC$ is a fusion category and $\cM$ and $\cN$ are finite semisimple module categories \cite{0909.3140}.  A construction of the relative Deligne tensor product for certain non-semisimple categories can also be extracted from \cite[Thm 3.1]{1102.3411}.   In this paper, we give a construction of the Deligne tensor product under the assumption that $\cC$ is a finite tensor category in the sense of \cite{MR2119143} and $\cM$ and $\cN$ are finite module categories.  This construction will play a key role in our study of the $3$-category of finite tensor categories and the associated local toplogical field theories in our papers \cite{???}.

The key result underlying our construction is due to Ostrik in the fusion case and Etingof-Ostrik for finite tensor categories, which shows that any module category can be realized as a category of modules.

\begin{theorem}{\cite[\S 3.2]{MR2119143}, \cite[Thm 2.11.6]{EGNO}, \cite[Thm 1]{MR1976459}} \label{thm:EGNO2.11.6}
