...
\end{alignat*}  \NS{Is this in the right place?  We don't refer to it in this paper, we do use it briefly in the other paper in the proof of the tensor products are functor categories theorem.  It should probably be moved to DTCI.}
