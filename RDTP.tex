...
Because $P$ is projective\NS{I don't follow this step}, the unit \NS{Changed composite to unit}
\begin{equation*}
	M \rightarrow \Hom_{\cC}(P, P \otimes_A M) \cong \Hom_{\cC}(P, P) \otimes_A M \cong M
\end{equation*}
 is isomorphic to the identity functor. \NS{Added $M \rightarrow$} It only remains to show that the counit 
\begin{equation*}
