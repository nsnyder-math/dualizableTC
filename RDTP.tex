...
\end{definition}
\nid The balanced tensor product is also known as the ``relative Deligne tensor product", because the (unbalanced) tensor product $\cM \boxtimes \cN$ of linear categories is often called the ``Deligne tensor product".  \NS{The punctuation outside quotes looks weird to me, but I'm assuming it was intentional, and I don't really care, so I didn't change it.}
