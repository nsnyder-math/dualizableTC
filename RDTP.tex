...
Now suppose that $p$ is a $\cC$-projective $\cC$-generator.  We will proceed similarly to Prop.~\ref{prop:finitelinearcatsasmodules}. We wish to show that the unit and counit of the adjunction $F \dashv \IHom(p,-)$ are isomorphisms. By assumption, $\IHom(p, -)$ is a $\cC$-module functor. Thus for each $c \in \cC$ we have a natural isomorphism
\begin{equation*}
