...
\end{proposition}
\begin{proof}
	It is standard that, for $A$ a finite-dimensional $k$-algebra, the linear category $\Mod{A}{}$ satisfies the four conditions. \NS{I propose replacing this proof by a reference to Introduction to Representation Theory}
