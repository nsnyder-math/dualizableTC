...
\begin{equation*}
	\IHom(p, -): \cM \to \cC.
\end{equation*}
The claim now follows from the well-known fact that the Yoneda embedding reflects exact sequences.  \NS{I wasn't able to follow this argument, perhaps it could use some more detail?}
\end{proof}
...
\begin{theorem} \label{thm:DelignePrdtOverATCExists}  \NS{This theorem needs a right exactness of the action assumption.}
...
\begin{corollary}%\label{cor:}
	\CSPcomm{Balanced tensor product over perfect fields preserves rigidity.}
\end{corollary}
...
\begin{proof}
	...
	This last follows from the crude monadicity theorem \CSP{get reference for crude monadicity thm} and the observations:
	\begin{itemize}
