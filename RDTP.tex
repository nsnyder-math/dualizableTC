...
\end{alignat*}  \NS{Is this remark on adjunctions in the right place?  We don't refer to it in this paper, we do use it briefly in the other paper in the proof of the tensor products are functor categories theorem.  It should probably be moved to DTCI.}
...
\subsection{Module categories have an internal hom} \NS{I think this subsection should be called ``Module categories" and the subsection break should be moved up half a page, putting the internal hom into the next subsection (whose name doesn't need to change).}
...
\end{lemma} \CD{This is point 1 after remark 2.11.3 in EGNO.}
