...
\NS{I wasn't able to follow this argument, perhaps it could use some more detail?}
\CSP{I think what was there was wrong. I changed it, so I think it is more clear now what is going on.}
\end{proof}
...
\begin{theorem} \label{thm:DelignePrdtOverATCExists}  \NS{This theorem needs a right exactness of the action assumption.} \CSP{You are right. I added it.}
