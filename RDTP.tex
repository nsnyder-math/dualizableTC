...
\begin{proof}[Proof of Prop. \ref{prop:finitelinearcatsasmodules}]  \NS{Should this be more parallel with the proof of Prop 2.23?}
...
Now suppose that $p$ is a $\cC$-projective $\cC$-generator.  We will proceed similarly to Prop.~\ref{prop:finitelinearcatsasmodules}. We wish to show that the unit and counit of the adjunction $F \dashv \IHom(p,-)$ are isomorphisms. By assumption, $\IHom(p, -)$ is a $\cC$-module functor and 


Thus for each $c \in \cC$ we have a natural isomorphism
\begin{equation*}
	\IHom(p, c \otimes p) \cong c \otimes
\end{equation*}
