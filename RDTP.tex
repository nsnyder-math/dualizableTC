...
\begin{lemma}\label{lem:partially_exact_action}
	Let $\cC$ be a tensor category and $\cM$ a $\cC$-module category. Then for each object $c \in \cC$, the action map $c \otimes (-): \cM \to \cM$ is exact. This holds without assuming right-exactness in either variable of the action functor. 
\end{lemma}
