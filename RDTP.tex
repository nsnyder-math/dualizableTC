...
\begin{lemma}\label{lem:recognizefinitecats}
	Let $F: \cC \leftrightarrows \cD: U$ be an adjunction between linear categories in which $U$ and $F$ are linear functors, and where $U$ is faithful and reflects isomorphisms. Suppose that $\cC$ is finite, then $\cD$ is also finite. 
\end{lemma}
