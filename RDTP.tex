...
\end{proposition}
\begin{proof}
	It is standard that, for $A$ a finite-dimensional $k$-algebra, the linear category $\Mod{A}{}$ satisfies the four conditions. \NS{Should we say more here?  Isn't this whole proposition standard?  Should we add a citation?}
