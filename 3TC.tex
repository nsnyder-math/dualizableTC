...
\end{equation}
It follows from \cite{0905.0462} and \cite{1001.4071} that this is a Quillen equivalence. In particular two Segal $n$-category give rise to weakly equivalent $n$-fold complete Segal spaces only if they are weakly equivalent as Segal $n$-categories. 
\CSP{It is kinda tricky to see this from \cite{0905.0462} and \cite{1001.4071}, and also needs results of Toen and Dugger. Not sure if we should go into this.}
