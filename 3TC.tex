...
\section{The Segal construction} \label{sec-SegalConstruction}
...
\begin{itemize}
	...
	\item BM Prop 6.5 gives us that $sk_n X \to X$ is a generalized Reedy cofibration whenever $X$ is gen. Reedy cofibrant. 
	...
	\item A monomorphism $A_+ \to t_1^*X$ is a cofibration for $\Gamma_{\leq 1}$-objects, hence 
	\begin{equation*}
		t_{1,!} A_+ \to t_{1,!}t_1^*X = sk_1 X
	\end{equation*}
	is a gen. Reedy cofibration of Gamma-objects. Here $t_{1,!} A_+$ is the free Gamma object generated by $A_+$. It will generally not satisfy the Segal conditions, but that is okay. 
\end{itemize}
