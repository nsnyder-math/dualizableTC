...
what we do:
\begin{itemize}
	\item Expository account of $\Delta$ and $\Gamma$ approaches
	\item Review model categories of Segal $n$-cats and $n$-fold complete Segal spaces (how they are related), and also symmetric monoidal variants. 
	\item review dualizability and invariance in these model categories
	\item review basics of theory of tensor categories.
	\item Construct the symmetric monoidal Segal 3-category of tensor categories.
\end{itemize}
...
Following this reasoning gives rise to the notion of weak $n$-category first proposed by Tamsamani \cite{tamsamani}. In what follows we will describe the $(\infty,n)$-variant of this construction, first given by Hirschowitz and Simpson \cite{math.AG/9807049},  where sets are replaced by (simplicial) spaces.  
...
\noindent In the next section we will make this definition more precise. We will also review some of the existing model categories of $(\infty,n)$-categories which are based on the above ideas.  
...
The above lemma is a special case of a more general result, which is well-known. The category of discrete Segal 2-categories forms a good model for the theory of bicategories. \CSPcomm{cite Leinster? Tamsamani? Lack?} 
...
Thus the homotopy hypothesis holds for $n$-fold complete Segal spaces as well as for  Segal $n$-categories. This latter equivalence was already established between discrete Segal $n$-categories and homotopy $n$-types by Tamsamani \cite{????} \CSPcomm{[Sur des notions de n-categorie et n-groupoide non- stricte via des ensembles multi-simpliciaux.]}
