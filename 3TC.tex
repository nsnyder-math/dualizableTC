...
\title{A 3-category of tensor categories}
...
\CSPcomm{[...]
\begin{itemize}
	\item Interest in TQFTs, 3D tqfts especially. 
	\item extended tqfts, cobordism hypothesis. 
	\item 3-category of tensor categories, bimodule categories, functors, nat trans.
\end{itemize}
}

Lurie's overview of his proof of the cobordism hypothesis employs the language of $n$-fold iterated complete Segal spaces introduced Clark Barwick \cite{???}, or more precisely the symmetric monoidal variant thereof. In this work we construct $\TC$ as an object of the symmetric monoidal variant of Simpsons' Segal $n$-categories.  
 In this case it is slightly easier to construct examples in the latter model. Nevertheless, we review the connection between these two models, describing how to obtain a  $n$-fold complete Segal space from a Segal $n$-category. Thus we may apply Lurie's results directly. We pay careful attention to the matter of full-dualizbality. Moreover these sections have a significant amount of expository material about symmetric monoidal $n$-categories, which we hope will make it more accessible to readers coming from topology or algebra.
%%
...
\section{Symmetric monoidal $(\infty,n)$-categories}
