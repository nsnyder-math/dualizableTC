...
\begin{abstract}
We show that fusion categories are objects of a symmetric monoidal 3-category of tensor categories.  
\end{abstract}
...
\section{The Deligne tensor product and finite linear categories}
