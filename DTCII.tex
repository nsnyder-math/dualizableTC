...
\end{proposition}
\begin{proof}
That $\pi_4(\Sigma \RP^2) = \ZZ/4$ is \cite[Prop. 6.5(3)]{MR1955357}. \NS{Not sure how to extract the second part from what's written in Wu. I added the pdf of Wu's book to Git in a papers folder. See page 97, the definition of $Y_2$ is on page 93-94. Note that $P_3(2) = \Sigma \RP^2$.}
\end{proof}
