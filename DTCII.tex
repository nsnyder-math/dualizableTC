...
\begin{constr}[The figure 8 construction]
...
\begin{constr}[The stable figure 8 construction]
...
\begin{constr}[The figure 64 construction]
...
\begin{constr}[The figure 32 construction]
...
\begin{constr}[The bean construction]
\label{bean}
...
\begin{proof}
The desired equation $e = -q$ follows if $e + q = 0$, which follows if $e - q = -2q = 2q$.  It therefore suffices to show that the union of \cref{rad8} and the negative of construction~\eqref{eq-q} is homotopic to \cref{bean}.  This is indeed the case:
\begin{equation} \nn
\cb{\begin{tikzpicture}
\draw[linestyle,looseness=1.25]
(0,0) to [out=-90,in=-120] (.5,0)
