...
\nid This (3,3)-category $\TC$, of finite tensor categories, finite bimodule categories, bimodule functors, and bimodule transformations, is a subcategory of the $(\infty,3)$-category $\mathrm{Alg}_1^{\text{strong}}(\mathrm{Rex})$ of algebra objects (with bimodules and strong bimodule functors) in the $(\infty,2)$-category of finitely-cocomplete linear categories (with right exact functors)---that $(\infty,3)$-category exists by Johnson-Freyd--Scheimbauer's construction of higher categories of higher algebra objects~\cite{jfs}.
