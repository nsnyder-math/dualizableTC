...
\end{lemma}
\CD{This lemma is Cor 4.2.6 in TC3, and has a proof there, as a corollary of the adjoint functor theorem.  I think (but am not sure) that that theorem and its proof should move to an appendix of this paper.}
\CD{Also, add comment that this lemma is well known, used in O and EO, but not proved anywhere.}
...
\CD{2-category v bicategory terminology issue}
...
%\subsection{Enrichment of module categories and rigidity} \label{sec:tc-bimod}
