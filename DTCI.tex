...
\CSP{I checked the latest version of Greenough's arxiv paper (v4) and it still uses the same faulty lemma. I added the version to the bib entry. Note this there is also a published version, which must surely use the same faulty lemma.}
\end{remark} %!%CDNC
...
\CD{CD to fix the mistakes around here}
