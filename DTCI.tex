...
\CSP{there is a missing citation here.}
...
\NS{Somewhere add remark on why alg closed is useful? (1. simple unit works (otherwise need abs simpl), 2. quadratic expressions.) eg $Rep(\mathbb{Z}/3)$ over $\RR$ global dimension issue.}
