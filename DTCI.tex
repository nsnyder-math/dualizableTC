...
\nid Note that Schaumann has investigated the duality properties (though not explicitly the dualizability in a cobordism-hypothesis sense) of a 3-category of spherical fusion categories over an algebraically closed field of characteristic zero~\cite{Schaumann-PhD}.
