...
Since we are working over a perfect field part (6) of Theorem~\ref{thm:DelignePrdtOverATCExists} applies, with the consequence that, for a general object $x \in \cM \boxtimes \cN$, it is enough to show that the functor
\begin{align*}
