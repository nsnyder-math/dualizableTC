...
\end{equation*}
See \cite{MR1976459, EO-ftc, EGNO} and \cite[\S 3.1--3.2]{BTP} for more details on the internal hom construction and this identification.
...
\begin{equation*}
	...
	\end{array}
\end{equation*}
The pair $(u,m)$ gives $R$ the structure of an algebra object, the pair $(\lambda, \Delta)$ gives $R$ the structure of coalgebra object, and $b$ and $c$ satisfy the usual zig-zag relations. The entire structure is completely determine by specifying the algebra structure $(u,m)$ and the counit $\lambda$.
