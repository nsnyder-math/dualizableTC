...
This is easily seen to be independent of the choice of isomorphism between $x$ and its double dual (since $x$ is simple, different choices of $a$ only differ by multiplication by a scalar). Moreover the magnitude only depends on the isomorphism class of $x$. 
\begin{definition}
...
\end{definition}
\noindent The magnitude of simple objects (`dimension squared') and the global dimension were introduced by M\"uger \cite{MR1966524} in the context of spherical fusion categories.
