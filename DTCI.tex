...
\begin{example}[The category of Hopf bimodules] \label{Ex:Hopf_bimod} \NS{This example needs to be rewritten post BTP}
	Let $\cC$ be a finite tensor category, and consider it as a left $\cC \boxtimes \cC^\mp$-module category. Let $A = \IHom(1,1)$ be the enriched endomorphism object of $1 \in \cC$ (cf. section \ref{sec:tc-bimod}); $A$ is an algebra object in $\cC \boxtimes \cC^\mp$. 
