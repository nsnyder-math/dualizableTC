...
In this section we prove the main theorem, that separable finite tensor categories are fully dualizable.  Throughout this section $\cC$ and $\cD$ will always denote finite tensor categories (i.e. objects of $\TC$), while $\cM$ and $\cN$ will always denote finite module categories (i.e. $1$-morphisms of $\TC$), and $\cF$ and $\cG$ will always denote right exact module functors (i.e. $2$-morphisms of $\TC$)
