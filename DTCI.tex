...
The cobordism hypothesis predicts the existence of an $O(3)$-action on the 3-groupoid of separable fusion categories, and we will give a complete description of this action and of several important homotopy fixed point spaces in future work. In this work we will describe a portion of this action. The underlying space of $SO(3)$ is $\RR \PP^2$, which induces an $A_\infty$-homomorphism $\Omega \Sigma (\RR \PP^2) \to SO(3)$ from the free $A_\infty$-group generated by the (pointed) space $\RR \PP^2$. We completely and explicitly describe the $\Omega \Sigma (\RR \PP^2)$-action on separable fusion categories, indeed on the 3-groupoid of fully-dualizable objects of any symmetric monoidal 3-category. 
...
\CSP{Is it possible to rewrite this last two paragraphs without using the TFT?}
