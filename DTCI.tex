...
\end{align*}
By construction we have $e_{i \overline{i}, 1} = \varepsilon_i$ and $\hat{e}_{i \overline{i}, 1} = \overline{\eta}_i$. 
...
\end{equation*}
From this description is it clear that the window element $b \circ c = \dim(\cC)$, the global dimension of $\cC$. 
