...
\CD{I vote for them being separate.}
...
\NS{Maybe only define 1, 2, and 3 dualizability, but state the cobordism hypothesis for all n (noting that we only use it for $n \leq 3$)?} \CD{I'll do this.}

\nid In the next section we describe the notion of framing referred to in this classification.  We refer the reader to Appendix~\ref{app:ch} for a more detailed and precise review of the notion of full dualizability and statement of the cobordism hypothesis.  
...
\subsection{Tensor categories, bimodule categories, and the Deligne tensor product} \label{sec:tc-lincat}
	...
	Let $k$ be a fixed ground field, let $\overline{\Vect}_k$ be the category of (possibly infinite-dimensional) $k$-vector spaces, and let $\Vect_k$ be the category of finite-dimensional $k$-vector spaces.   A {\em linear category} is an abelian category with a compatible enrichment over $\overline{\Vect}_k$ (that is, an enrichment whose underlying enrichment over the category of abelian groups agrees with the given abelian structure). A {\em linear functor} is a right exact additive functor, that is also a functor of $\overline{\Vect}_k$-enriched categories. 
...
\addtocontents{toc}{\protect\contentsline{section}{\protect\tocsection{}{}{App. A. The cobordism hypothesis\hspace{\fill}}}{\thepage}{}}%\hspace{-3.4pt}}{}}
%\addtocontents{toc}{\SkipTocEntry}
...
We can now recall the notion of full dualizability.
...
\addtocontents{toc}{\SkipTocEntry}
\section*{Homotopy extension for field theories} \label{sec:Hom_ext_field_thy}
\addtocontents{toc}{\protect\contentsline{section}{\protect\tocsection{}{}{App. B. Homotopy extension for field theories\hspace{\fill}}}{\thepage}{}}%\hspace{-3.4pt}}{}}
%\addtocontents{toc}{\SkipTocEntry}
