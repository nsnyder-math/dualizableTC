...
\end{definition}
\nid The full sub-3-category of $\TCss$ on the separable tensor categories will be of special significance: in Section~\ref{sec:separableisfd} we will prove it is a fully dualizable 3-category. \CD{Check/mention product of separable is separable --- actually, change 3.5.10 to a corollary, verified by a special case of the fact that prod of sep bimods is sep} %!%!% Check ordinary product of separable is separable. --- for Def 3.5.10 below. full sub3cat ... "is symmetric monoidal (...) and will be of special significance:"
\begin{definition}
The \emph{symmetric monoidal 3-category of separable tensor categories} $\TCsep$ (over a perfect field) has objects the separable tensor categories, morphisms the separable bimodule categories, 2-morphisms the bimodule functors, and 3-morphisms the bimodule transformations.
\end{definition}
