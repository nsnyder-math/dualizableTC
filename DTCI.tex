...
The dualizability of semisimple bimodule categories and functors between them has also been considered by Schaumann \cite{Schaumann-PhD} in the more limited context of spherical fusion categories over the complex numbers. Schaumann's primary goal, quite different from our own, is to highlight a three-dimensional graphical calculus valid in this setting. In his work many of the subtle distinctions between left and right duals disappear due to the assumption of sphericality and the existence of `bimodule traces'.  \NS{I added ``to" to correct a typo.  I rewrote my own version of this paragraph and commented it out.}

%A different version of dualizability of semisimple bimodule categories and functors between them was considered independently by Schaumann \cite{Schaumann-PhD} in the more limited context of spherical fusion categories over the complex numbers. Schaumann's primary goal, quite different from our own, is to develop a three-dimensional graphical calculus valid in this setting. In his work many of the subtle distinctions between left and right duals disappear due to the assumption of sphericality.
