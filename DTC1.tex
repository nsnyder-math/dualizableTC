...
\nid Note that seperability is a technical condition which is automatic over a field of characterstic $0$, and is implied by non-zero global dimension over a perfect field.
...
The end of the paper, Sections~\ref{sec-serre} and~\ref{sec-pivot}, focuses on the correspondence between algebraic properties of the tensor categories and topological properties of the corresonding field theories.  We focus particularly on the Serre automorphism, which, roughly speaking, measures the dependence of the field theory on spin structures.
...
\subsection{The Serre automorphism of a seperable fusion category}
...
\begin{corollary}
If $\cC$ is a seperable fusion category, then ${}_{\langle{}^{****}(-)\rangle} \cC \cong {}_{\langle\id\rangle} \cC$.
\end{corollary}
