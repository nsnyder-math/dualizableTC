...
\begin{corollary}
	A tensor category $(\cC, \otimes, 1)$ is rigid if and only if there exists an equivalence of tensor categories ${{}^*(-)}: \cC \to \cC^\mp$ and natural transformations
	\begin{align*}
		ev: & x \otimes {}^*x \to 1 \\
		coev:&  1 \to {}^*x \otimes x
	\end{align*}
	Satisfying the evident zig-zag equation. \\
	\CSPcomm{Working on this, need to explain why evaluation is a {\em natural} transformation, and why you onlyt need one of the functors.}
\end{corollary}
