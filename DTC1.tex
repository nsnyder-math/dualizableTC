...
\CSPcomm{[Background on simplcial objects in categories, $n$-fold simplcial spaces, and $\Gamma$ objects in categories. How fiber products over a discrete base are the same as homotopy fiber products.]}
...
A strict 2-category gives rise to a simplicial category $C_\bullet$ whose $n^\tehxt{th}$ category is given by the usual formula
\begin{equation*}
