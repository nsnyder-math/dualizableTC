...
In Section \ref{sec-dualfusion} we prove our main results (see Theorem \ref{???} and Theorem \ref{???}) for more detailed statements}.
...
The end of the paper, Sections~\ref{sec-serre} and~\ref{sec-pivot}, focuses on applications of the main result.

\begin{theorem}
The Serre automorphism of a fusion category $\cC$ is the bimodule associated to the double dual functor $**: \cC \ra \cC$.
\end{theorem}

Because the Serre automorphism is necessarily order 2, this theorem provides a simple topological proof of the following generalization Radford's theorem to fusion categories (originally due to ENO):
\begin{corollary}
