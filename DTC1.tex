...
\begin{theorem}
Finite tensor categories %whose tensor product is biexact, 
are fully 2-dualizable. 
%(that is, fully dualizable in the (3,2) truncation of the $3$-category of finite monoidal categories). \CD{Gaaa, this theorem should be rewritten.  Too technical and unclear for the introduction.  Maybe rephrase in terms of the kind of field theory that results.}
\end{theorem}
...
\begin{theorem}
The Serre automorphism of a finite rigid tensor category $\cC$ is the bimodule associated to the double dual functor $**: \cC \ra \cC$.  \NS{Left or right double dual?} \CD{It's the functor ${}^{**}(--)$ which we are still arguing about whether to call the left or right double dual.}
\end{theorem}
