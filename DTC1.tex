...
In $3$-dimensions, the Serre automorphism is necessarily order 2 (since $\pi_1(\mathrm{SO}_3) \cont \mathbb{Z}/2$), this theorem provides a simple topological proof of the following generalization Radford's theorem to fusion categories (originally due to ENO).
\begin{corollary}
