...
\NScomm{Add the converse and dimensional reduction here.}
...
\begin{definition}
Suppose that $\cC$ is a finite tensor category and $\cF: \cC \rightarrow \cC$ is an automorphism of tensor categories.  Let ${}_{\{\cF\}} \cC$ denote $\cC$ as a $\cC$--$\cC$ bimodule where the action is $x \cdot c \cdot y = \cF(x) \otimes c \otimes y$.  
...
If $\cC$ is a finite tensor category, then the Serre bimodule $\bimod{\cC}{\cS}{\cC}$ for $\cC$ is equivalent as a bimodule category to ${}_{\{\ldd{(-)}\}} \cC$, ${}_{\langle\ldd{(-)}\rangle} \cC$.
\end{theorem}
