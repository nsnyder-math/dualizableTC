...
\begin{remark}
If $\cM$ and $\cN$ are right $\cD$-modules, then we have that $\cN \boxtimes_\cD \Fun_{\text{mod-}\cD}(\cM,\cD) \simeq \Fun_{\text{mod-}\cD}(\cM,\cN)$, and again if $\cM$ and $\cN$ are bimodule categories, then this equivalence is a bimodule equivalence. \CD{I corrected this remark.  Make sure you still agree.}
\end{remark}
...
\end{remark} \CD{The $\cC$s, $\cD$s, $\cE$s in this remark are not correct.}
