...
\begin{theorem} \label{thm:SepModCats}
	...
	\end{enumerate}
	Moreover $\cM$ is semisimple. \\
	Furthermore, if $\cC$ is rigid, then $\cM$ is an exact $\cC$-module category. The analogous results hold for left module categories as well. 
\end{theorem}
