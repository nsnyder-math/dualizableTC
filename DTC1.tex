...
\NS{Say something about the natural transformation} \CD{I think this notation is slightly suboptimal.  What about ${}_{\cF}{\cC}$?  No, I guess that's no better.  How about ${}_{\langle \cF \rangle}{\cC}$?}
\end{definition}
...
\end{theorem}
\begin{proof}
\NS{CD and CSP are working on this.}
\end{proof}
...
Fusion categories are objects of the 3-category $\TCfin$ of tensor categories, but in this 3-category, pivotal and spherical structures are not natural from this point of view.  Specifically they are not homotopy invariant notions.  That is to say, if $\cC$ and $\cD$ are fusion categories which are equivalence in $\TCfin$ (that is, Morita equivalent), there's no natural equivalence between the space of spherical structures on $\cC$ and the space of spherical structures on $\cD$, as the following example shows.
