...
\CSPcomm{
\begin{itemize}
	\item The 2-morphisms of $\lincat(A)$ are ...
	\item The assignment $A \mapsto \lincat(A)$ gives a strict functor from $\Gamma^\op \simeq \Fin_*$ to strict 2-categories, which we also denote by $\lincat$. 
	\item $\lincat(A) \simeq \lincat^{\times A}$
