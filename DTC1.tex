...
\begin{theorem}
The Serre automorphism of a finite monoidal category $\cC$ is the bimodule associated to the double dual functor $**: \cC \ra \cC$.  \NS{Left or right double dual?}
\end{theorem}
...
\NS{This paragraph needs more references, do you two know of stuff to add?}
...
Noah Snyder and Chrs Schommer--Pries were supported by NSF Postdoctoral Fellowships.  \NS{Other grants?}
