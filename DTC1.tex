...
correspondence that allows us to translate algebraic statements and
...
Turaev--Viro construction in three ways. First it provides a local,
that is fully extended, TFT. Second, it allows us to relax the assumption of
sphericality on the fusion category: an arbitrary fusion category
gives a 3-framed TFT. Finally, it allows us to show that finite  tensor categories
