...
For all objects $a, b \in \cC$, the vector space $\Hom(a,b)$ is finite dimensional.
\item The category $\cC$ is semisimple, with finitely many simple objects.
\item For 
\end{enumerate}
\end{definition}
...
\begin{equation*}
	X \cong A \otimes_A X \otimes_A A \staackrel{s \otimes_A 1 \otimes_A s}{\longrightarrow} (A \otimes A) \otimes_A X \otimes_A (A \otimes A) \cong A \otimes X \otimes A,
\end{equation*}  	
