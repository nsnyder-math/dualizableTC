...
In Section \ref{sec-lft} we discuss local field theory, recall Lurie's statement of the Baez-Dolan cobordism hypothesis, and discuss several topological notions which come up in $3$-dimensional field theory.  We briefly recall the outline of Lurie's proof, indicating how some aspects of it have been simplified by more recent results.  
