...
\CSP{Yes we need this generality to express the universl property of the tensor product of a $\cC$-$\cD$-bimodule  and a $\cC'$-$\cD'$-bimodule.}
%	\begin{itemize}
		 $F$ is the identity on objects,
		 and the restriction of $F$ to each hom category is linear.
...
\CSPcomm{We will give a new proof of this theorem based on the fact that fusion categories are fully dualizable objects in a certain symmetric monoidal 3-category.}
