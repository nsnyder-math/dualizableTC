...
It can be shown (for example by constructing a projective generator) that a linear category is finite if and only if it is equivalent to the category $\Mod{A}{}$ of finite dimensional modules over a finite dimensional $k$-algebra $A$.
...
Just as any finite tensor category is a category of modules over an algebra, any finite module category over a tensor category is a category of module objects over an algebra object.  This is one of the main theorems of [EGNO], and is essentially to the structure theory of finite tensor categories.
...
\subsection{Notation for 3-framed manifolds}

\CD{I will write down here the precise conventions for drawing 3-framed manifolds.  Once I've done that, we'll be able to delete section 6.1.1.}
