...
& via $\cC^\op \xra{(-)^*} \cC^\mp$ \\
left arc fuzz out & $\bimod{\Vec}{\cC}{\cC \btimes \cC^\op}$ 
& via $\cC^\op \xra{{}^*(-)} \cC^\mp$ \\
right arc fuzz in & $\bimod{\cC^\op \btimes \cC}{\cC}{\Vec}$ 
& via $\cC^\op \xra{{}^*(-)} \cC^\mp$ \\
left arc fuzz in & $\bimod{\Vec}{\cC}{\cC^\op \btimes \cC}$ 
& via $\cC^\op \xra{(-)^*} \cC^\mp$ \\
loop down fuzz up bordism & $\bimod{\cC}{\cC}{\cC}$ & via $\cC_{\text{in}} \xra{{}^{**}(-)} \cC$\\
loop up fuzz up bordism & $\bimod{\cC}{\cC}{\cC}$ & via $\cC_{\text{in}} \xra{(-)^{**}} \cC$\\
loop down fuzz down bordism & $\bimod{\cC^\op}{\cC^\op}{\cC^\op}$ & via $\cC^\op_{\text{in}} \xra{{}^{**}(-)} \cC^\op$\\
loop down fuzz up bordism & $\bimod{\cC^\op}{\cC^\op}{\cC^\op}$ & via $\cC^\op_{\text{in}} \xra{(-)^{**}} \cC^\op$\\
circle fuzz out & ... &\\
circle fuzz in & ... &\\
circle with inward loop, fuzz out & ... &\\
circle with outward loop, fuzz out & ... & 
\end{tabular}
\end{table}
...
\CD{Should we add the two circles with loops but with fuzz in?}

\nid A few sample 2-framed 2-manifolds, together with their invariants, are listed in the following table:
\begin{table}[!h]
\begin{tabular}{c|cl}
&&
\end{tabular}
...
\CDcomm{Next add table for 2-framed 2-manifolds}
