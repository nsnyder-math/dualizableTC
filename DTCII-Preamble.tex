...
%\usepackage{graphicx}
%\usepackage{attachfile2}      % for the downloadable attachment
%\usepackage[bigfiles]{pdfbase}% low-level PDF objects (ships with media9)
%\usepackage{xparse}           % needed by the macros
...
\newenvironment{tconstr}[2][]{%
  \begingroup
  \renewcommand{\thetheorem}{#2}% <-- override the *theorem* counter's printform
  \begin{constr}[#1]%
}{%
  \end{constr}%
  \endgroup
...
\newcommand{\piv}{\mathsf{Piv}}
\newcommand{\sph}{\mathsf{Sph}}
\newcommand{\Ucon}{\mathsf{U}}
\newcommand{\vcon}{\mathsf{v}}
\newcommand{\wcon}{\mathsf{w}}
